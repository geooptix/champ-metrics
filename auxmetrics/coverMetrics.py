...
def visitCoverMetrics(visitMetrics, visit, riparianStructures):
...
def percentBigTreeCover(visitMetrics, riparianStructures):
    ...
    if inScope.__len__() > 0:
        visitMetrics["PercentBigTreeCover"] = numpy.mean(inScope)
    else:
...
def percentUnderstoryCover(visitMetrics, riparianStructures):
    ...
    if inScope.__len__() > 0:
        understoryCover = numpy.mean(inScope)
...
def percentNonWoodyGroundCover(visitMetrics, visit, riparianStructures):
    ...
    if inScope.__len__() > 0:
        visitMetrics["PercentNonWoodyGroundCover"] = numpy.mean(inScope)
    else:
...
def percentWoodyCover(visitMetrics, riparianStructures):
    ...
    if inScope.__len__() > 0:
        visitMetrics["PercentWoodyCover"] = numpy.mean(inScope)
    else:
...
def percentGroundCover(visitMetrics, riparianStructures):
    ...
    if inScope.__len__() > 0:
        visitMetrics["PercentGroundCover"] = numpy.mean(inScope)
    else:
...
def percentGroundCoverNoCover(visitMetrics, riparianStructures):
    ...
    if inScope.__len__() > 0:
        visitMetrics["PercentGroundCoverNoCover"] = numpy.mean(inScope)
    else:
...
def percentCanopyNoCover(visitMetrics, riparianStructures):
    ...
    if inScope.__len__() > 0:
        visitMetrics["PercentCanopyNoCover"] = 100 - numpy.mean(inScope)
    else:
